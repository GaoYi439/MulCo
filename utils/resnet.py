...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, in_channel=3, zero_init_residual=False):
        ...
        self.bn = nn.BatchNorm2d(512 * block.expansion)  # new
...
class SupConResNet(nn.Module):
    ...
    def __init__(self, name='resnet18', head='mlp', feat_dim=128, num_class=0, pretrained=False):
        '''
        :param name: choose model
        :param head: Projection Network
        ...
        self.fc = nn.Linear(dim_in, num_class)  # 线性分类层
